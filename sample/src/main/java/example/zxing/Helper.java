...
public class Helper extends AppCompatActivity {
    ...
    private String uriApiGetItem = "http://qr.dico.vn/api/get-product/";
...
/*        return "";
    ...
    public String getPhoneNumber1(Context c) {*/
        String phoneNo = "";
    ...
    /** Call history */
   /* public void history(Context context, Intent intent) {
        // Do something in response to button

        Intent startActivity = new Intent();
        startActivity.setClass(context, DetailActivity.class);
...
//&& isNetworkConnected(context)
       if (tokenKey == null) {
           //Toast.makeText(conTxt, "abc123", Toast.LENGTH_LONG).show();
           requestToken();
       }
   }
