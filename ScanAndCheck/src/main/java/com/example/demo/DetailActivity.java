    ...
    private class GetClass extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            try {
                ...
                final JSONObject objReader = new JSONObject(jsonStr);
                ...
                DetailActivity.this.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            responseCode = Integer.parseInt(objReader.getString("ResponseCode").toString());

                            statusMessage = objReader.getString("StatusMessage").toString();
                            statusColor = objReader.getString("StatusMessageColor").toString().replace("“", "");

                            if (responseCode == 1) {
                                JSONObject obj = objReader.getJSONObject("ObjectData");
